...
#Notebooks
#Reorder probability (estimates how likely a user is to actually use or repurchase an item)
Reordering_Model_ML_Update_1.ipynb
#Waste risk (identifies items historically associated with leftover quantities or low utilization)
waste_prediction_model(1).ipynb
#Spoilage risk (captures perishability and shelf‑life constraints)
